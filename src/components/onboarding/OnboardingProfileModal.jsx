...
const i18n = {
  fr: {
    ...
    saved: 'Vos informations ont bien été enregistrées. Bienvenue sur votre espace TrackSmart Retail.',
    step_of: 'Étape',
    of: 'sur',
  },
  en: {
    ...
    saved: 'Your information has been saved. Welcome to your TrackSmart Retail account.',
    step_of: 'Step',
    of: 'of',
  },
};
